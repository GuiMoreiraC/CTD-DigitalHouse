...
SELECT MAX(valor_total), cidade_cobranca
FROM faturas
...
SELECT AVG(valor_total), pais_cobranca
FROM faturas
...
-- 9 - Formate a data do nascimento dos funcionários no formato ex: "02 May2020"(DATE_FORMAT)
